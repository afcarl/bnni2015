...
nn.learningRate = 0.0001;        % multiply gradient by this when changing weights
nn.momentum = 0.99;              % inertia - add this much of previous weight change
%nn.scaling_learningRate = 0.9219; % multiply learning rate by this after each epoch
%nn.activation_function = 'tanh_opt';   % activation function: tanh_opt, sigm or relu
%nn.dropoutFraction = 0.1094;     % disable this much hidden nodes during each iteration
%nn.weightPenaltyL2 = 5.9375e-05;     % penalize big weights by subtracting 
